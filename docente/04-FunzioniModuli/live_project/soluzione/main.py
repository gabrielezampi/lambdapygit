...
è la soluzione al progetto live della quarta lezione del corso.
...
Questa versione dello script implementa le funzionalità in modo ottimizzato,
seguendo le best practice discusse.
"""
